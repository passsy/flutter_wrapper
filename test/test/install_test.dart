  ...
  group('install', () {
    ...
    group("install in git root", () {
      ...
      setUpAll(() async {
        ...
        appDir = Directory("${dir.absolute.path}/myApp/");
      ...
      test('created .flutter submodule', () async {
        expect(Directory("${appDir.path}/.flutter").existsSync(), isTrue);
      });
      test('downloaded dart tools', () async {
        expect(
            File("${appDir.path}/.flutter/bin/cache/dart-sdk/bin/dart")
                .existsSync(),
            isTrue);
        expect(
            File("${appDir.path}/.flutter/bin/cache/dart-sdk/bin/dartanalyzer")
                .existsSync(),
            isTrue);
        expect(
            File("${appDir.path}/.flutter/bin/cache/dart-sdk/bin/dartfmt")
                .existsSync(),
            isTrue);
        expect(
            File("${appDir.path}/.flutter/bin/cache/dart-sdk/bin/pub")
                .existsSync(),
            isTrue);
      });
